...
console.log("LuxuryBookingForm:", LuxuryBookingForm);
...
title:
`Book ${car.name} Luxury Car Rental | Maan Travels`,

description:
`Reserve ${car.name} with Maan Travels for weddings, VIP travel and premium chauffeur services.`
